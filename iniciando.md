...
![Pantalla de inicio de Google Colab](imagenes/01.png)
...
Una vez abierta, pincha en la parte superior donde dice "Conectar" en la parte superior derecha, esto preparará el entorno de ejecución, que por defecto corresponde a Python.
...
![Cuaderno en blanco con celda de código](imagenes/03.png)
...
![Cuaderno en blanco con celda de texto](imagenes/04.png)

[Escribiendo en el notebook](escribiendo.md)
